...
if __name__ == '__main__':
    ...
    def start_Serial_listener():
        serial_thread = Serial_Listener(name='Serial_listener', args=[True])
        serial_thread.start()
...
# zmq_thread.join()
Button(root, text='Serial listener start', command=start_Serial_listener).pack(side=TOP)
Button(root, text='Connect', command=connect_serial).pack(side=TOP)
